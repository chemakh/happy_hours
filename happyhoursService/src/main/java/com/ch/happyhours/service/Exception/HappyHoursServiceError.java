 ...
 */
public enum HappyHoursServiceError {
    ...
    ERR_HappyHours("error.InternalError", HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    HappyHoursServiceError(String message, HttpStatus httpStatus) {
